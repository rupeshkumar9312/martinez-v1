...
const committeeMembers = [
...

  {
    ...
    image:
      "https://media.licdn.com/dms/image/v2/D5603AQHxQHhnwoz1kQ/profile-displayphoto-shrink_200_200/profile-displayphoto-shrink_200_200/0/1710304751817?e=1776297600&v=beta&t=hle0dde2gbLxzHIqw70a8q1dzOU_KKItAuf1XKCNEO4",
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl md:text-2xl leading-relaxed opacity-90">
              Meet the visionaries and leaders guiding St. Martinez
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="text-4xl font-primary-bold text-text-black mb-6">
                Our Founders, Directors & Principal
              </h2>
              <p className="text-xl text-text-black/70 max-w-3xl mx-auto">
                The Managing Committee brings together a wealth of experience,
                passion, and dedication to ensure the holistic growth and
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-2 gap-12">
              {committeeMembers.map((member, idx) => (
                ...
                >
                  ...
                  <h3 className="text-2xl font-bold text-text-black mb-1">
                    {member.name}
                  </h3>
